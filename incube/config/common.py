...
class Common(Configuration):
    ...
    STRIPE_CLIENT_ID = os.environ['STRIPE_CLIENT_ID'] # Required, so no get
    STRIPE_SECRET_KEY = os.environ['STRIPE_SECRET_KEY'] # Required, so no get
    STRIPE_CONNECT_HOST = 'https://connect.stripe.com'
    STRIPE_AUTHORIZE_PATH = '/oauth/authorize'
    ...
    MIDDLEWARE = (
        ...
        'middlewares.IncubeSubdomainMiddleware',
    ...
    ADMINS = (
        ('Author', 'plamen@tuta.io'),
    )

    # Postgres
    DATABASES = values.DatabaseURLValue('postgres:///incube')
